...
if(isset($_POST["submit"])){
    ...
    for ($a = 0; $a < count($_POST["iName"]); $a++){
        $sql2 = "INSERT INTO recipe_ingredient (recipe_id, ingredient_amount, measurement_type, measurement_qty) VALUES ('$recipe_id', '".$_POST["iQty"][$a]."', '".$_POST["iUnit"][$a]."', '".$_POST["iName"][$a]."');"; 
